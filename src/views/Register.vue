            ...
            <div class="w-full md:w-1/2 ">
                ...
                <form action="" class="flex flex-col gap-4">
                    ...
                    <div>
                        ...
                        <input class="w-full border-gray-200 px-4 py-2 focus:outline-none" type="password" name="confirm-password" placeholder="******">
                    </div>

                    <div>
                        <input class="w-full bg-blue-600 py-2 rounded-md text-white font-bold cursor-pointer" type="button" value="Sign Up">
                    </div>
                </form>
